...
experiment.add_plugin(
    noise.add_noise(
        path_C_squared = '/g100_work/OGS23_PRACE_IT/csoto/eat/tests/experiments/Ensemble_two/no_assimilation_statistics/square_cov.npy',
            ...
            dump_noise_slide = [[196,392],[392, 588],[588, 784],[784, 980]], #phosphate (N1_p), nitrate (N3_n), 
...
experiment.add_observations('total_chlorophyll[-26]', '/g100_work/OGS23_PRACE_IT/csoto/eat/tests/experiments/Ensemble_two/observation/chla_std.txt')
